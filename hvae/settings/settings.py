...
VAE_SIZE=dict(hidden = [32, 64, 128, 256,512],
    k_sizes=[1,1,3,3,3],
    strides=[1,2,2,2,2],
    padding=[1,1,1,1,1],
    outpadding=[0,0,0,1,1])
...
VAE_HPARAMS = dict(
    ...
    disc_gamma= 30.,
    alpha=30.,
    hidden = VAE_SIZE['hidden'],
    k_sizes=VAE_SIZE['k_sizes'],
    strides=VAE_SIZE['strides'],
    padding=VAE_SIZE['padding'],
    outpadding=VAE_SIZE['outpadding'],
    hidden_d = VAE_SIZE['hidden'][::-1],
    k_sizes_d =VAE_SIZE['k_sizes'][::-1],
    strides_d = VAE_SIZE['strides'][::-1],
    padding_d = VAE_SIZE['padding'][::-1],
    outpadding_d = VAE_SIZE['outpadding'][::-1],
)
...
PRED_HPARAMS = dict(
    ...
    in_dim=VAE_HPARAMS['debed_sz_1']+VAE_HPARAMS['debed_sz_2'], 
